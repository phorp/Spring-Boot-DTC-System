<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"padding":"0","overflow-x":"hidden","margin":"0","position":"relative","display":"block","height":"auto"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":" 0px 0px 10px rgba(0, 0, 0, 0.5)","padding":"8px 20px","alignItems":"center","top":"0","background":"#5182b5","display":"flex","width":"100%","position":"fixed","zIndex":"1002","height":"calc(100px - 16px)"}'></index-header>
