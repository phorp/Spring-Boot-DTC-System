<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"width":"100%","borderColor":"#d8dce5","margin":"0px 0px 20px 210px","overflow":"hidden","borderStyle":"solid","borderWidth":"0"}'>
		<scroll-pane ref="scrollPane" class="tags-view-wrapper">
			<div class="tags-view-box" :style='{"boxShadow":"none","borderColor":"#c2c2c2","whiteSpace":"nowrap","background":"#fff","borderWidth":"0 0 1px 0","width":"calc(100% - 20px)","position":"absolute","borderStyle":"solid"}'>
