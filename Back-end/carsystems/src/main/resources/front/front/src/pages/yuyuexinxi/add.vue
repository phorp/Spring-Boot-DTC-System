...
<div :style='{"width":"100%","padding":"30px 18% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="预约类型" prop="yuyueleixing">
            <el-select v-model="ruleForm.yuyueleixing" placeholder="请选择预约类型" :disabled=" false  ||ro.yuyueleixing" multiple filterable>
              <el-option
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="预约情况" prop="yuyueqingkuang">
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="预约日期" prop="yuyueriqi">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="时间段" prop="shijianduan">
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="故障描述" prop="guzhangmiaoshu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="故障描述"
