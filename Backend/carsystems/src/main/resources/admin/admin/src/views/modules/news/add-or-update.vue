		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.introduction" label="简介" prop="introduction">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}'>{{ruleForm.introduction}}</span>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.content" label="内容" prop="content">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.content"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../carsystems/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
