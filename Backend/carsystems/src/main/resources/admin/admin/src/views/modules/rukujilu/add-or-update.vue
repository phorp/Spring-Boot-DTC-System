	...
	<div class="addEdit-block" :style='{"padding":"0 10px 60px 210px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="入库备注" prop="rukubeizhu">
					<el-input v-model="ruleForm.rukubeizhu" placeholder="入库备注" clearable  :readonly="ro.rukubeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="入库备注" prop="rukubeizhu">
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      ...
	      objcross.peijianshuliang = parseFloat(objcross.peijianshuliang) + parseFloat(this.ruleForm.peijianshuliang)
                }
      //更新跨表属性
       var crossuserid;
       var crossrefid;
