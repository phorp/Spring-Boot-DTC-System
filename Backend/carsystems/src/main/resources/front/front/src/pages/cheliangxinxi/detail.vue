    ...
    <div
      ...
      <el-breadcrumb :separator="'='"
        ...
        <el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index"
                            to="/index/cheliangxinxi"><a>{{ item.name }}</a></el-breadcrumb-item>
        ...
        <div class="info"
          ...
          <div class="btn" :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
            <el-button
                ...
                v-if="btnAuth('cheliangxinxi','修改')" @click="editClick">修改
            </el-button>
            <el-button
                ...
                v-if="btnAuth('cheliangxinxi','删除')" @click="delClick">删除
            </el-button>
            <el-button
                :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#f53400","borderRadius":"0px","background":"none","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}'
                v-if="btnAuth('cheliangxinxi','私聊')&&detail.id!=mid" @click="chatClick">联系TA
            </el-button>
            <el-button
                ...
                v-if="btnAuth('cheliangxinxi','服务预约')" @click="onAcross('yuyuexinxi','','','','')" type="warning">服务预约
            </el-button>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    backClick() {
      ...
      this.$router.push({path: '/index/cheliangxinxi', query: params});
    },
    // 下载
    download(file) {
      if (!file) {
