<template>
	...
	<div :style='{"width":"100%","overflow":"hidden","flexWrap":"wrap","background":"#fff","justifyContent":"space-between","display":"flex"}'>
		...
		<div class="hot" :style='{"width":"100%","margin":"0px auto","background":"#fff","height":"auto","order":"13"}'>
		  <div :style='{"padding":"0 0 10px","borderColor":"#0f0e13","color":"#4a576a","borderRadius":"0px","textAlign":"center","background":"none","borderWidth":"0 0 1px","width":"100%","lineHeight":"40px","fontSize":"30px","borderStyle":"solid"}'>热门文章</div>
