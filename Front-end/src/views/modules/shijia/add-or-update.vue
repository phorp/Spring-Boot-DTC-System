<template>
  <div class="addEdit-block" :style='{"padding":"0 10px 60px 210px"}'>
    ...
    >
      <template>
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="汽车品牌"
                      prop="qichepinpai">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="汽车型号"
                      prop="qichexinghao">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.cheliangtupian"
                      label="车辆图片" prop="cheliangtupian">
          <file-upload
              tip="点击上传车辆图片"
              action="file/upload"
              :limit="3"
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.cheliangtupian" label="车辆图片"
                      prop="cheliangtupian">
          ...
          <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index"
               v-for="(item,index) in ruleForm.cheliangtupian.split(',')" :src="$base.url+item" width="100"
               height="100">
        </el-form-item>

<!--        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="车牌号码"
                      prop="chepaihaoma">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="预约类型"
                      prop="yuyueleixing">
          <el-select :disabled="ro.yuyueleixing" v-model="ruleForm.yuyueleixing" placeholder="请选择预约类型" multiple
                     filterable>
            <el-option
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="预约情况"
                      prop="yuyueqingkuang">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yuyueriqi" label="预约日期"
                      prop="yuyueriqi">
          <el-input v-model="ruleForm.yuyueriqi" placeholder="预约日期" readonly></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="时间段"
                      prop="shijianduan">
      ...
      <el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="备注"
                    prop="guzhangmiaoshu">
        <el-input
      ...
      <el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.guzhangmiaoshu" label="备注"
                    prop="guzhangmiaoshu">
        <span
            :style='{"fontSize":"14px","lineHeight":"40px","color":"#666","fontWeight":"500","display":"inline-block"}'>{{ ruleForm.guzhangmiaoshu }}</span>
      </el-form-item>
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                if (data.data.total >= crossoptnum) {
                  ...
                  this.$http({
                    url: `shijia/${!this.ruleForm.id ? "save" : "update"}`,
                    method: "post",
                    data: this.ruleForm
                  }).then(({data}) => {
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.shijiaCrossAddOrUpdateFlag = false;
                          this.parent.search();
